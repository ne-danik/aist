...
var app = (function () {
    ...
    function create_fragment$j(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h3, "class", "section__title svelte-1obptcg");
    			add_location(h3, file$h, 6, 2, 126);
    			attr_dev(p, "class", "section__subtitle svelte-1obptcg");
    			add_location(p, file$h, 9, 2, 212);
    			attr_dev(div, "class", "section__heading svelte-1obptcg");
    ...
    class SectionHeading extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$j, create_fragment$j, safe_not_equal, { sectionTitle: 0, sectionSubtitle: 1 });
    ...
    class LogoColor extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$g, create_fragment$g, safe_not_equal, { src: 0, alt: 1, width: 2, height: 3 });
    ...
    class MediaQuery extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$b, create_fragment$b, safe_not_equal, { query: 1 });
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(ul, "class", "nav__list svelte-ik5syt");
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			attr_dev(a, "href", "/");
    			attr_dev(a, "class", "svelte-ik5syt");
    			add_location(a, file$9, 72, 18, 1796);
    			attr_dev(li, "class", "nav__list-item svelte-ik5syt");
    ...
    function create_each_block$3(ctx) {
    	...
    	let t1;
    	let t2;
    	let if_block = /*item*/ ctx[1].links && create_if_block$3(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			attr_dev(a, "class", "nav__heading-link svelte-ik5syt");
    			attr_dev(a, "href", "/");
    			add_location(a, file$9, 66, 12, 1555);
    			attr_dev(p, "class", "nav__heading svelte-ik5syt");
    			add_location(p, file$9, 65, 10, 1517);
    			attr_dev(div, "class", "nav svelte-ik5syt");
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "content svelte-ik5syt");
    			add_location(div0, file$9, 62, 4, 1429);
    			attr_dev(div1, "class", "wrapper");
    			add_location(div1, file$9, 61, 2, 1402);
    			attr_dev(div2, "class", "box svelte-ik5syt");
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(ul, "class", "menu__list svelte-157k14o");
    			add_location(ul, file$7, 47, 12, 1360);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, ul, anchor);
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr_dev(a, "class", "menu__link svelte-157k14o");
    			attr_dev(a, "href", /*menuItem*/ ctx[7].url);
    			add_location(a, file$7, 50, 18, 1489);
    			attr_dev(li, "class", "menu__item");
    			add_location(li, file$7, 49, 16, 1446);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    			append_dev(li, a);
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$7, 66, 2, 1835);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$8(ctx) {
    	...
    	let if_block = /*toggle*/ ctx[1] && create_if_block$2(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(nav, "class", "menu svelte-157k14o");
    			add_location(nav, file$7, 44, 6, 1241);
    			attr_dev(div0, "class", "header-inner svelte-157k14o");
    			add_location(div0, file$7, 39, 4, 1123);
    			attr_dev(div1, "class", "wrapper");
    			add_location(div1, file$7, 38, 2, 1096);
    			attr_dev(header, "class", "header svelte-157k14o");
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "subtitle svelte-19cvxal");
    			add_location(h2, file$6, 20, 4, 677);
    			attr_dev(h1, "class", "title svelte-19cvxal");
    			add_location(h1, file$6, 21, 4, 719);
    			attr_dev(p, "class", "svelte-19cvxal");
    			add_location(p, file$6, 22, 4, 755);
    			attr_dev(div0, "class", "heading svelte-19cvxal");
    			add_location(div0, file$6, 19, 2, 650);
    			attr_dev(div1, "class", "shadow svelte-19cvxal");
    			add_location(div1, file$6, 24, 2, 783);
    			attr_dev(img, "class", "down-btn__icon svelte-19cvxal");
    			...
    			attr_dev(img, "alt", "");
    			add_location(img, file$6, 27, 4, 859);
    			attr_dev(a, "class", "down-btn svelte-19cvxal");
    			attr_dev(a, "href", "#sportsComplex");
    			add_location(a, file$6, 26, 2, 811);
    			if (!src_url_equal(source.src, source_src_value = /*bgVideoUrl*/ ctx[4])) attr_dev(source, "src", source_src_value);
    			attr_dev(source, "type", /*format*/ ctx[5]);
    			add_location(source, file$6, 37, 4, 1074);
    			...
    			video.muted = true;
    			video.loop = true;
    			add_location(video, file$6, 36, 2, 1005);
    			attr_dev(div2, "class", "main svelte-19cvxal");
    			add_location(div2, file$6, 16, 0, 602);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('subtitle' in $$props) $$invalidate(1, subtitle = $$props.subtitle);
    		if ('altLogo' in $$props) $$invalidate(2, altLogo = $$props.altLogo);
    		if ('descr' in $$props) $$invalidate(6, descr = $$props.descr);
    	};
    	...
    	return [title, subtitle, altLogo, poster, bgVideoUrl, format, descr];
    }
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t = text(t_value);
    			attr_dev(p, "class", "descr svelte-q4vafx");
    			add_location(p, file$2, 84, 16, 6971);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot_1(ctx) {
    	let if_block_anchor;
    	let if_block = /*matches*/ ctx[7] && create_if_block_1(ctx);
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			a = element("a");
    			t = text("Подробнее");
    			attr_dev(a, "class", "more svelte-q4vafx");
    			attr_dev(a, "href", /*item*/ ctx[4].urlMore);
    			add_location(a, file$2, 90, 14, 7177);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			attr_dev(svg, "class", "item-icon svelte-q4vafx");
    			...
    			attr_dev(div0, "class", "image svelte-q4vafx");
    			add_location(div0, file$2, 67, 10, 6391);
    			attr_dev(h4, "class", "title svelte-q4vafx");
    			add_location(h4, file$2, 81, 12, 6823);
    			attr_dev(div1, "class", "content svelte-q4vafx");
    			add_location(div1, file$2, 80, 10, 6788);
    			attr_dev(a, "class", "item svelte-q4vafx");
    			attr_dev(a, "href", /*item*/ ctx[4].urlMore);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "items svelte-q4vafx");
    			add_location(div0, file$2, 64, 4, 6285);
    			attr_dev(div1, "class", "wrapper");
    			add_location(div1, file$2, 58, 2, 6109);
    			attr_dev(section, "class", "section sports-complex svelte-q4vafx");
